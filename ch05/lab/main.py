...
def graph_coordinates(threenplus1_iters_dict):
    ...
    while 1:
        ...
        pygame.draw.lines(display, "blue", False, list(threenplus1_iters_dict.items()), width=1)
        ...
        new_display = pygame.transform.scale(display, (width * 5, height * 5))
        display.blit(new_display, (0, 0))
        new_display = pygame.transform.flip(display, False, True)
        display.blit(new_display, (0, 0))
        font = pygame.font.Font(None, 48)
        msg = font.render(("Max so far is: "+ str(max_so_far)), False, "Blue")
        display.blit(msg, (300,10))
        pygame.display.flip()
        break
